<template>
  ...
  >
    <div
      class="flex lg:flex-row flex-col items-center justify-between col-span-12 grid grid-cols-12 col-span-12"
    >
    ...
    >
      ...
      >
        <a
          ...
          aria-label="Linkden"
        >
          <svg class="w-12 h-12 fill-current" viewBox="0 0 512 512">
            <path
