<template>
  <div v-if="pagina">
    ...
    <div v-if="pagina.header">
      ...
      >
        <div
          class="mb-24 lg:max-w-xl h-full sm:text-center flex flex-col justify-center align-center text-white"
        >
          <p
            class="inline-flex justify-center px-3 mt-4 text-3xl lg:text-6xl md:text-2xl font-semibold tracking-wider rounded-full"
          >
    ...
    <v-container class="lg:my-48 my-20 px-8">
      <p class="text-2xl lg:text-6xl lg:leading-relaxed text-gray-700 font-weight-bold">
        {{ pagina.body.texto }}
      </p>
    </v-container>

    <v-container
      class="grid grid-cols-12 mb-48 gap-x-0 lg:gap-x-8 gap-y-8 px-4"
      v-if="pagina.secciones"
    >
      <!-- [SECCION ASOCIADOS] -->
      <div
        v-if="pagina.secciones[0]"
        class="flex flex-col justify-center border-2 border-gray-100 lg:row-span-1 lg:col-span-7 col-span-12 pa-8 rounded-xl"
      >
        <p class="text-3xl lg:text-4xl mb-8 text-gray-700">
        ...
        <v-img
          ...
          class="rounded-xl h-72 lg:h-96"
        ></v-img>
        <p class="text-lg lg:text-2xl mt-8 lg:leading-loose text-gray-600">
      ...
      <div
        ...
        class="flex flex-col justify-center border-2 border-gray-100 lg:row-span-1 lg:col-span-5 col-span-12 pa-8 rounded-xl"
      >
        <p class="text-3xl lg:text-4xl mb-8 text-gray-700">
      ...
      <div
        ...
        class="flex flex-col justify-center border-2 border-gray-100 lg:row-span-1 lg:col-span-6 col-span-12 pa-8 rounded-xl"
      >
        <p class="text-3xl lg:text-4xl mb-8 text-gray-700">
      ...
      <div class="col-span-12 mt-32" v-if="pagina.secciones[4]">
        <p class="text-2xl lg:text-6xl lg:leading-relaxed text-gray-700 font-weight-bold">
          {{ pagina.secciones[4].texto }}
        </p>
      </div>

      <div
        class="col-span-12 mt-12 flex align-center"
        v-if="pagina.secciones[5]"
      >
